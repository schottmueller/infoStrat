...
- preliminary: Register for the "examination" via KLIPS by October 31. Deregistering will not be possible after October 31 for scheduling reasons.
- preliminary: Dates for the presentations are announced in November. Student presentations take place in January (and possibly December).
- preliminary: Hand in your paper by March 1, 2020. 
** Plan

A preliminary plan can be found [[https://github.com/schottmueller/infoStrat/blob/master/plan.org][here]]. (A less often updated pdf with properly formatted references is available [[https://github.com/schottmueller/infoStrat/files/3702057/plan.pdf][here]].)
