...
* News
 - The paper we discuss on Oct. 19 can be downloaded [[http://dx.doi.org/10.1016/j.jmateco.2015.01.005][here]]. Please, read the paper using the methodology described in the guide on how to read a paper.
